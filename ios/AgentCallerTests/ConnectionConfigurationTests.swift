...
final class ConnectionConfigurationTests: XCTestCase {
    ...
    func testAgentInstructionsUseManagedRelayAndNeverRequestAppleCredentials() {
        ...
        XCTAssertTrue(instructions.contains("voice_connector.py diagnose"))
        XCTAssertTrue(instructions.contains("openai-codex"))
        XCTAssertTrue(instructions.contains("XAI_API_KEY"))
        XCTAssertTrue(instructions.contains("Never ask me to paste a key or OAuth token into Caller"))
    ...
    func testConnectedAgentUpdateInstructionsPreservePairingAndExplainNewCapabilities() {
        ...
        XCTAssertTrue(instructions.contains("voice_connector.py install"))
        XCTAssertTrue(instructions.contains("openai-codex"))
